...
class NewRaptor:
    ...
    def run(self):
        ...
        if result:
            ...
            valLast = self.dlg.dte.date()

            QMessageBox.information(self.dlg, "Message", "New raptor {}\n Buffer {}\n Lat {}\n Lng {}\n Species {}".format(valNestID, valBuffer, valLat, valLng, valSpecies))
            ...
            # Find linear projects that will be impacted and report them
            ...
            for linear in linears :
                ...
                if valDistance < valBuffer :
                    ...
                    dlgTable.tblImpacts.setItem(row, 2, QTableWidgetItem(str(valDistance)))
